 ...
 */
async function buildReplayResponse(userId: string, vocabularyId: string): Promise<ReviewResultResponse> {
...
export const POST = withApiHandler(
  async (
    ...
    let result: { update: Awaited<ReturnType<typeof persistTargetReview>>; gameProfile: GameProfileGain };
    try {
      ...
      const update = await persistTargetReview(tx, "vocab", userId, id, userVocabulary, grade, now);
